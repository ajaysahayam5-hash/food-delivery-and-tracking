...
- Backend (Render): `https://food-delivery-backend-j4kb.onrender.com` — health: `/api/health`, Swagger: `/swagger-ui.html`
- Frontend API base: `VITE_API_URL=https://food-delivery-backend-j4kb.onrender.com/api` (set in Vercel env + `frontend/.env.production`)
